...
export default function ContactFooter() {
  ...
  return (
    <div style={{ marginTop: "60px" }}>
      ...
      <div className="portfolio-bottom-grid scroll-reveal delay-500">
        <div>
          <div className="portfolio-section-title">{home.contact.helpTitle}</div>
          <div className="portfolio-help-list">
            {home.contact.helpItems.map((help, idx) => (
              <div className="portfolio-help-item" key={help.title}>
                <div className="portfolio-help-icon">
                  {idx === 0 && (
                ...
                <div className="portfolio-help-info">
                  <h4>{help.title}</h4>
                  <p>{help.desc}</p>
                </div>
              </div>
        ...
        <div>
          <div className="portfolio-section-title">{home.contact.contactTitle}</div>
