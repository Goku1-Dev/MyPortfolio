...
export default function ResumePage() {
  ...
  return (
    <div className="scroll-reveal delay-100" style={{ paddingBottom: "40px" }}>
      <div className="portfolio-section-title" style={{ fontSize: "18px", marginBottom: "8px" }}>{portfolioText.otherPages.resumeTitle}</div>
      <p style={{ color: "var(--portfolio-text)", marginBottom: "20px", fontSize: "13px" }}>{resume.subtitle}</p>

      <div style={{ display: "flex", gap: "15px", marginBottom: "40px", flexWrap: "wrap" }}>
        <button
          className="portfolio-btn delay-200"
          onClick={handleView}
        ...
        >
          <svg style={{ width: "16px", height: "16px", marginRight: "6px" }} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
