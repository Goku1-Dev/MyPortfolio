  ...
  return (
    <div class="portfolio-about-page fade-in">
      ...
      <div class="portfolio-about-banner-container">
        <img class="portfolio-about-banner" src="/banner.png" alt="Banner background" />
        <img class="portfolio-about-avatar" src="/profile.png" alt="Profile picture" />
      </div>
        ...
        {data.workExperience.items.map((item) => (
          <div class="portfolio-experience-item">
            <div class="portfolio-experience-header">
              <h5>
                {item.companyUrl ? (
                  <a href={item.companyUrl} target="_blank" rel="noopener noreferrer" style={{ display: "flex", alignItems: "center", gap: "6px", color: "inherit", textDecoration: "none" }} class="portfolio-company-link">
                    {item.company}
